import { type NodeList, type Entity } from '@ash.ts/ash';
import { GadgetNode, HomeSystem, PropertiesComponent, PropertyAccessMode, serviceLocator, type uuidT } from '@sinkapoy/home-core';
